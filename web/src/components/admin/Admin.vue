            ...
            <div class="main-content">
                <div class="listTodo">
                    <draggable class="dragArea" :list="list" item-key="id" :animation="100" :move="moveList">
                        <List v-for="(item,index) in list" :id="item.id" @openQuickEdit="openQuickEdit" @closeControlModal="closeControlModal" :key="index" @updateCardList="getDataList" @updateListTitle="handleUpdateList" @reloadList="reloadList" @openActionList="openActionList" @openDetailCard="openDetailCard" :index="item.index" :item="item" />
                    </draggable>
                            ...
                            <div class="card-detail-data u-gutter">
                                <div v-if="cardDetail.labels.length>0" class="card-detail-item card-detail-item-labels u-clearfix js-card-detail-labels">
                                    ...
                                    <div class="u-clearfix js-card-detail-labels-list js-edit-label">
                                        ...
                                        <a v-if="userAdmin" class="card-detail-item-add-button" @click="openControlLabel">
                                ...
                                <div v-if="cardDetail.deadline!=null" class="card-detail-item card-detail-due-date">
                                    ...
                                    <div class="card-detail-due-date-badge js-card-detail-due-date-badge is-clickable is-due-complete" title="Thẻ này đã hoàn tất.">
                                        <el-checkbox v-if="userAdmin" v-model="isComplete" @change="changeStatusTodo"></el-checkbox>
                                        <div class="card-detail-badge-due-date-react-container">
                                            <div class="card-deadline-badge">
                                                <button class="deadline-badge datetime-btn" data-test-id="due-date-badge-with-date-range-picker" type="button">
                                                    ...
                                                    <span class="card-deadline-status card-die" v-if="!isComplete && isDeadline===1">Quá hạn</span>
                                                    <span class="card-deadline-status card-near-die" v-if="cardDetail.status === 2">Gần đến hạn</span>
                                                    <span class="nch-icon">
                                ...
                                <div>
                                    <div class="window-module">
                                        <div>
                                            ...
                                            <div class="editable" attr="desc" style="padding-left: 45px; display: flex">
                                                ...
                                                <el-dropdown trigger="click" @command="assign" style="line-height: 60px; margin-left: 25px; cursor: pointer">
                                                    <span v-if="!cardDetail.user" class="el-dropdown-link">
                                        ...
                                        <div class="window-module-title window-module-title-no-divider description-title">
                                            ...
                                            <div v-if="userAdmin" class="editable" attr="desc">
                                                <a class="nch-button ml-4 hide-on-edit js-show-with-desc js-edit-desc js-edit-desc-button hide" v-if="!editDescriptionModal && cardDetail.description !=null" @click="openEditDescription">Chỉnh
                                                    sửa</a>
                                        ...
                                        <div class="u-gutter">
                                            <div class="editable" attr="desc">
                                                <div class="description-content js-desc-content">
                                                    ...
                                                    <p v-if="!editDescriptionModal && cardDetail.description==null && userAdmin" @click="openEditDescription" class="u-bottom js-hide-with-desc">
                                                        <a class="description-fake-text-area hide-on-edit js-edit-desc  js-hide-with-draft" href="#">Thêm
                                                            mô tả chi tiết hơn...</a></p>
                                                    <p v-if="!editDescriptionModal && cardDetail.description!=null && userAdmin" @click="openEditDescription" class="u-bottom js-hide-with-desc">
                                                        <a class="description-fake-text-area hide-on-edit js-edit-desc  js-hide-with-draft" href="#">{{ cardDetail.description}}</a>
                                                    </p>
                                                    <p v-if="!editDescriptionModal && cardDetail.description!=null && !userAdmin" class="u-bottom js-hide-with-desc">
                                                        <a class="description-fake-text-area hide-on-edit js-edit-desc  js-hide-with-draft" href="#">{{ cardDetail.description}}</a>
                                                    </p>
